...
const SHADOW = "0 0 24px rgba(34,42,53,.06),0 1px 1px rgba(0,0,0,.05),0 0 0 1px rgba(34,42,53,.04),0 0 4px rgba(34,42,53,.08),0 16px 68px rgba(47,48,55,.05),0 1px 0 rgba(255,255,255,.1) inset";
...
export const NavbarLogo = () => (
    <Link to="/" className="flex items-center gap-1 group cursor-pointer">
        ...
        <span className="text-2xl font-bold tracking-tight font-sans">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Fi</span>
        </span>
        <img
            src="/securities.png"
            alt="VeriFi Logo"
                ...
                {userData ? (
                    <>
                        <div ref={(el) => (itemsRef.current[0] = el)}>
                            <Link to={userData.role === 'advisor' ? '/advisor/dashboard' : '/investor/dashboard'}>
                                <Button variant="ghost" size="sm" className="rounded-full text-md font-light text-white hover:bg-white/10">
                    ...
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" size="icon" className="rounded-full h-8 w-8 bg-gradient-to-br from-blue-500 to-purple-600 border-0">
